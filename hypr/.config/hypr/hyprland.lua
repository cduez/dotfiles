...
local menu        = 'bemenu-run -i -p "Run:" --tf "#888888" --ff "#ffffff" --hf "#33ccffee"'
...
hl.config({
    ...
    group = {
      col = {
        border_active = "rgb(40C9A7)",
        border_inactive = "rgba(8e8e8eaa)",
      },
    ...
    decoration = {
        ...
        -- no dim for specials / scratchpad
        dim_special = 0,
